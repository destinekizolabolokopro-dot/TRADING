...
**Règle du projet : uniquement H1 / H4 / D1 — aucune prise de position sous H1 (tout en HTF).**
...
| `bot_scalp.js` | **Signaux intraday** — mêmes détections, filtré sur l'exploitable | H1 · H4 · D1 | `DISCORD_WEBHOOK_SCALP` |
